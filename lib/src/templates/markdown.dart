...
import 'package:invoices/src/templates/parser.dart' show markdownDecoder;
...
final class Markdown {
  ...
  /// {@macro markdown}
  const Markdown({required this.markdown, required this.blocks});

  /// Empty markdown.
  /// {@macro markdown}
  const Markdown.empty() : markdown = '', blocks = const <MD$Block>[];
  ...
  /// {@macro markdown}
  factory Markdown.fromString(String markdown) => markdownDecoder.convert(markdown);
